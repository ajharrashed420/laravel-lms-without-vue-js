          ...
          <div class="container">
                ...
                <ol role="list" class="flex items-center space-x-0.5">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <div class="-m-1" href="#">
                        <a href="{{route('course', $course->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{$course->name}} </a>
                      </div>
                    </div>
                  </li>
                </ol>
            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                  ...
                  <h2 class="mt-4 pt-4 mb-4 text-lg font-bold text-gray-900"> Episodes </h2>
                  <div class="px-6 py-4 bg-white shadow-md rounded-sm">
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Intro </p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Our first HTTP test </p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Using a database </p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Testing exceptions </p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Testing domain code </p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="px-5 py-4">
                          <div class="flex items-start justify-between">
                            <div class="flex items-center">
                              ...
                              <div class="ml-3">
                                <p class="text-sm font-semibold text-gray-900">Custom factories </p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <button type="button" class="inline-flex items-center rounded border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 mt-4 mb-2"> Show All Episodes </button>
                  </div>
                    ...
                    <div class="space-y-4 p-6">
                      ...
                      <div class="space-y-4 pb-2">
                        ...
                        <div class="text-sm px-7">
                          <p class="text-gray-500">{{$author->author_bio}}</p>
                        </div>
                      </div>
                      @endforeach
                  ...
                  <div class="overflow-hidden bg-white border border-gray-200 rounded-sm mt-6 shadow-sm">
                    <div class="px-4 py-5 sm:p-6">
                      ...
                      <div class="mt-8 flex flex-wrap gap-2.5">
                        @foreach($course->topices as $topic)
